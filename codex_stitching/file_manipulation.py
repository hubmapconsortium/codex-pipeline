...
def copy_best_z_planes_to_channel_dirs(img_dirs: List[Path], out_dir: Path, dataset_meta: dict):
    ...
    channel_dirs, best_z_plane_paths = get_output_dirs_and_paths(img_dirs, out_dir, num_channels_per_cycle, nzplanes, x_ntiles, y_ntiles, tiling_mode, reference_channel)
