...
def create_cellshapes_csv_files( tileNamesAndFiles, cellShapesCsvDir ) :
...
if __name__ == "__main__" :
    ...
    tileNamesAndFiles = collect_tile_names( ometiffFileList, cytometryStatsDir )
